...
namespace AdministracionSanatorio
{
    public class Hospital
    {
        ...
        public Hospital()
        {
            ...
            Intervenciones.Add(new Intervencion("INT001", "Bypass coronario", "Cardiología", 120000));
            Intervenciones.Add(new Intervencion("INT003", "Artroscopía de rodilla", "Traumatología", 80000));
            Intervenciones.Add(new Intervencion("INT005", "Endoscopía digestiva", "Gastroenterología", 40000));
            Intervenciones.Add(new Intervencion("INT007", "Colocación de stent", "Cardiología", 95000));
            Intervenciones.Add(new Intervencion("INT008", "Reducción de fractura", "Traumatología", 60000));

            // Intervenciones de alta complejidad
            Intervenciones.Add(new AltaComplejidad("INT002", "Neurocirugía", "Neurología", 200000));
            Intervenciones.Add(new AltaComplejidad("INT004", "Revascularización miocárdica", "Cardiología", 250000));
            Intervenciones.Add(new AltaComplejidad("INT006", "Cirugía de columna", "Traumatología", 180000));
